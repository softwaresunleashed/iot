<?php
   ...
   function sendPushNotificationToGCM($registration_ids, $message) {
		...
		// key for IoT Temperature Monitoring project ==> AIzaSyDXJjMCvU-_ByaEzP-WlZWvrXz9hXe7occ
		define("API_KEY", "AIzaSyDXJjMCvU-_ByaEzP-WlZWvrXz9hXe7occ"); 	// edit to add your API Key	
        $headers = array(
